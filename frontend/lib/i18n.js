...
export const translations = {
  en: {
    ...
    aiAgentsWillAnalyze: "10+ specialized AI agents will analyze your symptoms",
    ...
    stepByStepPlan: "STEP-BY-STEP TREATMENT PLAN",
    whenToSeekCare: "WHEN TO SEEK MEDICAL CARE",
    drugInteractions: "Drug Interaction Alerts",
    aiAnalysis: "AI Doctor's Detailed Analysis",
    reasoningTrace: "How did AI decide this?",
    noDataYet: "Run a diagnosis to see results here.",
  ...
  ta: {
    ...
    treatmentTitle: "சிகிச்சை திட்டம்",
    drug: "மருந்து",
    dosage: "அளவு",
    duration: "காலம்",
    ...
    stepByStepPlan: "படிப்படியான சிகிச்சை திட்டம்",
    whenToSeekCare: "மருத்துவ உதவி எப்போது நாட வேண்டும்",
    drugInteractions: "மருந்து தொடர்பு எச்சரிக்கைகள்",
    aiAnalysis: "AI மருத்துவரின் விரிவான பகுப்பாய்வு",
    reasoningTrace: "AI எப்படி முடிவெடுத்தது?",
    noDataYet: "முடிவுகளை காண கண்டறிதலை இயக்கவும்.",
  ...
  hi: {
    ...
    clinicalExplanation: "नैदानिक व्याख्या",
    stepByStepPlan: "चरण-दर-चरण उपचार योजना",
    whenToSeekCare: "चिकित्सा सहायता कब लें",
    drugInteractions: "दवा परस्पर क्रिया अलर्ट",
    aiAnalysis: "AI चिकित्सक का विस्तृत विश्लेषण",
    reasoningTrace: "AI ने यह निर्णय कैसे लिया?",
    noDataYet: "परिणाम देखने के लिए निदान चलाएं।",
